        ...
        <Paper sx={{ p: 3, mb: 4 }}>
          ...
          <Box sx={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
            <Box>
              ...
              <Typography>{new Date(order.created_at).toLocaleDateString('vi-VN')}</Typography>
            </Box>
            <Box>
              <Typography variant="subtitle2" color="textSecondary">
                Trạng Thái
            ...
            <Box>
              ...
              <Typography>{order.payment_method || 'COD'}</Typography>
            </Box>
            <Box>
              <Typography variant="subtitle2" color="textSecondary">
                Tổng tiền
              </Typography>
              <Typography sx={{ fontSize: '1.2em', fontWeight: 'bold', color: 'primary.main' }}>
