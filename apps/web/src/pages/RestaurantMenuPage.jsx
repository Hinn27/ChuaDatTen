...
export function RestaurantMenuPage() {
    ...
    return (
        ...
        >
            <Box component="div" className="rp-page">
                <Box component="section" className="rp-hero">
                    <Box className="rp-hero-bg" />
                    <Box className="oui-container rp-hero-inner">
                        <Box className="rp-hero-top">
                            ...
                            <Typography component="p" className="rp-demo-link">
                                <Link to="/restaurant/tandoori-pizza-london/order">
                                    Xem trang đặt món (demo)
                                </Link>
                            </Typography>
                        </Box>
                ...
                <Box className="rp-cat-search oui-container">
                    <Box className="rp-cat-scroll" role="tablist">
                        {CATEGORIES.map((c) => (
                            <Button
                                key={c}
                                type="button"
                ...
                >
                    <Box className="oui-container">
                        ...
                        <Box className="rp-offers-row">
                            {OFFERS.map((o) => (
                                <Box
                                    component="article"
                                    key={o.id}
                                    className="rp-offer-card"
                                >
                                    <img src={o.img} alt="" loading="lazy" />
                                    <Box className="rp-offer-bar">
                                        <Typography component="strong">
                                            {o.title}
                                        </Typography>
                                        <Button
                                            type="button"
                                            className="rp-icon-add"
                ...
                {isError && (
                    <Box component="section" className="rp-section">
                        <Box className="oui-container">
                            <Typography component="p">
                                Khong the tai san pham tu API, hien thi du lieu
                                mau.
                            </Typography>
                        </Box>
                    </Box>
                        ...
                        <Box className="oui-container">
                            ...
                            <Box className="rp-menu-grid">
                                {section.items.map((item) => (
                                    ...
                                    >
                                        <Box className="rp-menu-card-text">
                                        ...
                                        <Box className="rp-menu-card-img">
                                            <img
                                                src={item.img}
                                                alt=""
                                                loading="lazy"
                ...
                >
                    <Box className="oui-container rp-info-grid">
                        ...
                        <Box className="rp-info-card">
                            ...
                            <Typography component="p">
                                123 High Street, East London, E1 6AN
                            </Typography>
                            <Typography component="p">
